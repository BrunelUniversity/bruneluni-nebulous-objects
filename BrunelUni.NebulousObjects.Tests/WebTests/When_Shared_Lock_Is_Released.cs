...
public class When_Shared_Lock_Is_Released : Given_A_NebulousManager
{
    private int _index;
    ...
    {
        _index = 0;
        SUT.ExitItemSharedLock<Person>( _index );
    }
    ...
    public void Then_Lock_Operation_Is_Sent( )
    {
        ...
        MockNebulousClient.Received( ).Send( Arg.Is<OperationDto>( o =>
            o.DataType == typeof( Person ) && o.Operation == OperationEnum.ExitSharedLock && o.Index == _index ) );
    }
}