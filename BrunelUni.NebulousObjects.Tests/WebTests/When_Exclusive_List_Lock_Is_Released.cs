...
public class When_Exclusive_List_Lock_Is_Released : Given_A_NebulousManager
{
    protected override void When( ) { SUT.ExitListExclusiveLock<Person>( ); }
    ...
    public void Then_Lock_Operation_Is_Sent( )
    {
        ...
        MockNebulousClient.Received( ).Send( Arg.Is<OperationDto>( o =>
            o.DataType == typeof( Person ) && o.Operation == OperationEnum.ExitExclusiveListLock ) );
    }
}