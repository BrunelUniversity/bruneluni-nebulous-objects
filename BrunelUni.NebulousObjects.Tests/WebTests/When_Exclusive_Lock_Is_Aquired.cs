...
public class When_Exclusive_Lock_Is_Aquired : Given_A_NebulousManager
{
    private int _index;
    ...
    {
        _index = 0;
        SUT.EnterItemExclusiveLock<Person>( _index );
    }
    ...
    public void Then_Lock_Operation_Is_Sent( )
    {
        ...
        MockNebulousClient.Received( ).Send( Arg.Is<OperationDto>( o =>
            o.DataType == typeof( Person ) && o.Operation == OperationEnum.EnterExclusiveLock && o.Index == _index ) );
    }
}